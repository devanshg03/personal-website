    ...
    <div className='w-full'>
        <div className='relative w-screen h-[30vh] lg:h-[40vh]'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2 '>Startr Up</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                <p>Project</p>
                <h2>Overview</h2>
                <p>This was an idea I had to make a tinder-style app that would match aspiring entrepreneurs with a startup idea that someone else needed help on. I coded this project and made a very simple app to show to others and validate my idea. In the end, I realized matching people just based on the idea would not work as there is so much more to building a team.</p>
            ...
            <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4'>
                <div className='p-2'>
                    ...
                    <div className='grid grid-cols-3 md:grid-cols-1'>
                        ...
                        <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>Python Flask</p>
                        <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>SQL</p>
                        <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>Product testing</p>
