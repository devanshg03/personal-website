  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
            <p className='uppercase text-xl tracking-widest text-[#5299D3]'>
                Contact
            </p>
                        ...
                        <form>
                            <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                                ...
                                <div className='flex flex-col py-2 md:col-span-2'>
                                    <label className='uppercase text-sm py-2'>Messafe</label>
                                    <textarea className='border-2 rounded-lg p-3 border-gray-300' rows='10'></textarea>
                                </div>

                                <button className='w-full p-4 text-gray-100 mt-4 md:col-span-2' >Send Message</button>
                            </div>
                        </form>
            ...
            <div className='flex justify-center py-12' >
                ...
                <div className='rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hove:scale-110 ease-in duration-300' >
                    <HiOutlineChevronDoubleUp className='text-[#5299D3]' size={30}/>
                </div>
                </Link>
            </div>
        </div>
